...
num_samples = 5
num_in_features = 20000
num_out_features = 10000
...
raw_low_rank_time = timeit.timeit('(x @ (low_rank_weights[0].T)) @ low_rank_weights[1].T', globals=globals(), number=10)
...
low_rank_time = timeit.timeit('low_rank_model(x)', globals=globals(), number=10)
